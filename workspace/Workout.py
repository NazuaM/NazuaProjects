...
workout = pd.read_csv("workspace/workout.csv")
...
three_key = pd.read_csv("workspace/three_keywords.csv")
...
three_country = pd.read_csv("workspace/workout_geo.csv")
...
four_country = pd.read_csv("workspace/three_keywords_geo.csv")
